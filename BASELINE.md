...
| Landscape tex / mountains | **DECIDED 2026-08-31, layered: Skyland AIO 1K 4.32 is the base; Vanaheimr 6.0 PBR 2K wins over the top. ERM (121336) 1.1.2 + Fix/Addon 6.4 + STEP DynDOLOD Add-On installed on vanilla texture paths, inheriting the winner.** | User's words: "Vanaheimr over the top yes! Skyland AIO is the base". Vanaheimr ERM patch (131170) queued; Vanaheimr install queued behind the #107 fix-floor job, with the Oldrim road-mesh recheck mandated before it lands. Evidence: `records/skyland-notwl-foundation-install-2026-08-30.md` and the installed-mod ledger. |

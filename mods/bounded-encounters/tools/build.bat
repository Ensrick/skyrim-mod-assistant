...
if not defined VCToolsVersion goto :fail
if not defined WindowsSDKVersion goto :fail
echo BE_CMAKE_VERSION_BEGIN
"%BE_CMAKE%" --version
if errorlevel 1 goto :fail
echo BE_CMAKE_VERSION_END
echo BE_NINJA_VERSION_BEGIN
"%BE_NINJA%" --version
if errorlevel 1 goto :fail
echo BE_NINJA_VERSION_END
echo BE_VCTOOLS_VERSION=%VCToolsVersion%
echo BE_WINDOWS_SDK_VERSION=%WindowsSDKVersion%

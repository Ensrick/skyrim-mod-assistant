...
namespace
{
	...
	void DisableManagerSafely(BoundedEncounters::EncounterManager* a_manager)
	{
		auto config = BoundedEncounters::DefaultConfig();
		config.enabled = false;
		a_manager->Initialize(std::move(config));
	}

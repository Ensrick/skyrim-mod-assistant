# Compatibility sweep decision record

`decisions.json` is the machine-readable input for the proposed owned
compatibility patch. It contains only record identities and field ownership;

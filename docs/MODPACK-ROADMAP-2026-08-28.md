...
- Freak's Floral Fields 3.2.3 is the active grass overhaul with DrJacopo's
  3D Grass Library 16.53. Floral Solstheim 1.0.1 and Floral Veil 1.0 extend it
  to Solstheim and the Soul Cairn. The realistic regional mix, nine light
  plugins, module ordering, and 4096-axis texture policy are recorded in
  `records/freaks-floral-fields-3.2.3-2026-08-30.md`. Generated cache and other
  grass utilities remain separate decisions.
...
| Grass | [#112](https://github.com/Ensrick/skyrim-mod-assistant/issues/112) | FFF 3.2.3 realistic regional mix + DrJacopo library + Floral Solstheim 1.0.1 + Floral Veil 1.0 enabled; static audits clean | Foreground-check Skyrim, Solstheim, and Soul Cairn density, biome fit, pop-in, seams and frame time, then decide utilities/cache. |

...
| NPC AI overhaul slot | **SKIPPED by the user 2026-09-03: Immersive Citizens - AI Overhaul (173).** He also excludes the author. His reasoning, recorded because it is a design principle and not just a verdict: *"The AI in Bethesda games already tends to be fairly complex. Adding more complexity to the routine of NPCs would also leave out the NPCs in other locations. I highly doubt that some of the mods adding new lands will have the depth or complexity in NPC routines and behavior that they do in Skyrim."* Deepening vanilla-Skyrim routines widens the gap against adopted worldspaces that cannot match it - Bruma being the possible exception, where townsfolk already keep routines like visiting the bar before bed. Measured support for the integration cost: IC's plugin is 6,505 records of which **190 are navmesh, 3,078 placed objects and 263 cells** - it rebuilds towns to support its AI - and it ships patches for ELE, ELFX and Open Cities only, nothing for this build's city stack. [AI Overhaul](https://www.nexusmods.com/skyrimspecialedition/mods/21654) touches **zero navmeshes** (3,263 records; Lite is 411, almost purely packages) and remains the candidate in `SLOT_CANDIDATES.md`. Neither is installed. |
